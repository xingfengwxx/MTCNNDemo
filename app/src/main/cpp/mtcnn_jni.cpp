//
// Created by WangXingxing on 2020/4/14.
//
...
Java_com_wangxingxing_mymtcnndemo_MTCNN_FaceDetectionModelInit(JNIEnv *env, jobject thiz,
                                                               jbyteArray det1_param,
                                                               jbyteArray det1_bin,
                                                               jbyteArray det2_param,
                                                               jbyteArray det2_bin,
                                                               jbyteArray det3_param,
                                                               jbyteArray det3_bin) {
...
Java_com_wangxingxing_mymtcnndemo_MTCNN_FaceDetect(JNIEnv *env, jobject thiz, jbyteArray image_date,
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_wangxingxing_mymtcnndemo_MTCNN_MaxFaceDetect(JNIEnv *env, jobject thiz,
                                                      jbyteArray image_date, jint image_width,
                                                      jint image_height, jint image_channel) {
    if(!detection_sdk_init_ok){
        LOGD("人脸检测MTCNN模型SDK未初始化，直接返回空");
        return NULL;
    }
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_wangxingxing_mymtcnndemo_MTCNN_FaceDetectionModelUnInit(JNIEnv *env, jobject thiz) {
    if(!detection_sdk_init_ok){
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_wangxingxing_mymtcnndemo_MTCNN_SetMinFaceSize(JNIEnv *env, jobject thiz, jint min_size) {
    if(!detection_sdk_init_ok){
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_wangxingxing_mymtcnndemo_MTCNN_SetThreadsNumber(JNIEnv *env, jobject thiz,
                                                         jint threads_number) {
    if(!detection_sdk_init_ok){
        LOGD("人脸检测MTCNN模型SDK未初始化，直接返回");
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_wangxingxing_mymtcnndemo_MTCNN_SetTimeCount(JNIEnv *env, jobject thiz, jint time_count) {
    if(!detection_sdk_init_ok){
        LOGD("人脸检测MTCNN模型SDK未初始化，直接返回");
        return false;
    }
